...
/*    */   
/*    */   public Strike_Red() {
/* 20 */     super("Strike_R", cardStrings.NAME, "red/attack/strike", 1, cardStrings.DESCRIPTION, CardType.ATTACK, CardColor.RED, CardRarity.BASIC, CardTarget.ENEMY);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 32 */     this.tags.add(CardTags.STRIKE);
/* 33 */     this.tags.add(CardTags.STARTER_STRIKE);
/*    */   }
/*    */ 
/*    */   
...
/*    */       } 
/*    */     } else {
/* 49 */       addToBot((AbstractGameAction)new DamageAction((AbstractCreature)m, new DamageInfo((AbstractCreature)p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
/*    */     } 
/*    */   }
/*    */ 
/*    */   
...
/* 63 */     return new Strike_Red();
/*    */   }
/*    */ }


/* Location:              E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\cards\red\Strike_Red.class
