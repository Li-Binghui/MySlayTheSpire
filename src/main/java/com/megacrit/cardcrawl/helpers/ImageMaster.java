...
/* loaded from: desktop-1.0.jar:com/megacrit/cardcrawl/helpers/ImageMaster.class */
public class ImageMaster {
    ...
    public static Texture[] PETAL_VFX;
    public static Texture[] WATER_DROP_VFX;
    ...
    public static ArrayList<Texture> LIGHTNING_PASSIVE_VFX;
    ...
    public static HashMap<String, Texture> relicImages;
    public static HashMap<String, Texture> relicOutlineImages;
    ...
    static {
        $assertionsDisabled = !ImageMaster.class.desiredAssertionStatus();
        logger = LogManager.getLogger(ImageMaster.class.getName());
        PETAL_VFX = new Texture[4];
        WATER_DROP_VFX = new Texture[6];
        LIGHTNING_PASSIVE_VFX = new ArrayList<>();
        relicImages = new HashMap<>();
        relicOutlineImages = new HashMap<>();
    }
    ...
    public static void initialize() {
        ...
        DEBUG_HITBOX_IMG.setFilter(Texture.TextureFilter.Nearest, Texture.TextureFilter.Nearest);
        ...
        WHITE_SQUARE_IMG.setFilter(Texture.TextureFilter.Nearest, Texture.TextureFilter.Nearest);
    ...
    public static void loadRelicImg(String id, String imgUrl) {
        if (!relicImages.containsKey(id)) {
            relicImages.put(id, loadImage(AbstractRelic.IMG_DIR + imgUrl));
            relicOutlineImages.put(id, loadImage(AbstractRelic.OUTLINE_DIR + imgUrl));
        }
    }

    public static Texture getRelicImg(String id) {
        return relicImages.get(id);
    }

    public static Texture getRelicOutlineImg(String id) {
        return relicOutlineImages.get(id);
    }
    ...
    public static void loadControllerImages(CInputHelper.ControllerModel model) {
        ...
        CONTROLLER_A = loadImage("images/ui/controller/" + dirName + "/a.png");
        CONTROLLER_B = loadImage("images/ui/controller/" + dirName + "/b.png");
        CONTROLLER_X = loadImage("images/ui/controller/" + dirName + "/x.png");
        CONTROLLER_Y = loadImage("images/ui/controller/" + dirName + "/y.png");
        CONTROLLER_LB = loadImage("images/ui/controller/" + dirName + "/lb.png");
        CONTROLLER_RB = loadImage("images/ui/controller/" + dirName + "/rb.png");
        CONTROLLER_BACK = loadImage("images/ui/controller/" + dirName + "/back.png");
        CONTROLLER_START = loadImage("images/ui/controller/" + dirName + "/start.png");
        CONTROLLER_LS = loadImage("images/ui/controller/" + dirName + "/ls.png");
        CONTROLLER_LS_UP = loadImage("images/ui/controller/" + dirName + "/ls_up.png");
        CONTROLLER_LS_DOWN = loadImage("images/ui/controller/" + dirName + "/ls_down.png");
        CONTROLLER_LS_LEFT = loadImage("images/ui/controller/" + dirName + "/ls_left.png");
        CONTROLLER_LS_RIGHT = loadImage("images/ui/controller/" + dirName + "/ls_right.png");
        CONTROLLER_RS = loadImage("images/ui/controller/" + dirName + "/rs.png");
        CONTROLLER_RS_UP = loadImage("images/ui/controller/" + dirName + "/rs_up.png");
        CONTROLLER_RS_DOWN = loadImage("images/ui/controller/" + dirName + "/rs_down.png");
        CONTROLLER_RS_LEFT = loadImage("images/ui/controller/" + dirName + "/rs_left.png");
        CONTROLLER_RS_RIGHT = loadImage("images/ui/controller/" + dirName + "/rs_right.png");
        CONTROLLER_D_UP = loadImage("images/ui/controller/" + dirName + "/up.png");
        CONTROLLER_D_DOWN = loadImage("images/ui/controller/" + dirName + "/down.png");
        CONTROLLER_D_LEFT = loadImage("images/ui/controller/" + dirName + "/left.png");
        CONTROLLER_D_RIGHT = loadImage("images/ui/controller/" + dirName + "/right.png");
        CONTROLLER_LT = loadImage("images/ui/controller/" + dirName + "/lt.png");
        CONTROLLER_RT = loadImage("images/ui/controller/" + dirName + "/rt.png");
    }
        ...
        if ($assertionsDisabled || imgUrl != null) {
            try {
                ...
                if (linearFiltering) {
                    ...
                    retVal.setFilter(Texture.TextureFilter.Nearest, Texture.TextureFilter.Nearest);
                }
                return retVal;
            } catch (Exception e) {
