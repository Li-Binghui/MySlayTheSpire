...
/* 29 */     this.scale = MathUtils.random(0.8F, 1.2F) * Settings.scale;
/* 30 */     this.dur_div2 = this.duration / 2.0F;
/* 31 */     this.color = new Color(1.0F, MathUtils.random(0.7F, 1.0F), 0.4F, 0.0F);
/*    */     
/* 33 */     this.oX += MathUtils.random(-50.0F, 50.0F) * Settings.scale;
/* 34 */     this.oY += MathUtils.random(-50.0F, 50.0F) * Settings.scale;
...
/* Location:              E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\vfx\ShineSparkleEffect.class
