...
/*  35 */   private char tablename0 = ' ';
/*  36 */   private char tablename1 = ' ';
/*  37 */   private char tablename2 = ' ';
/*     */   
/*     */   private int xlen;
/*     */   private int ylen;
/*     */   private int linbits;
/*  42 */   private int[][] val = (int[][])null;
/*     */   
/*     */   private int treelen;
/*  45 */   private static int[][] ValTab0 = new int[][] { { 0, 0 } };
/*     */ 
/*     */   
/*  48 */   private static int[][] ValTab1 = new int[][] { { 2, 1 }, { 0, 0 }, { 2, 1 }, { 0, 16 }, { 2, 1 }, { 0, 1 }, { 0, 17 } };
/*     */   
/*  50 */   private static int[][] ValTab2 = new int[][] { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 } };
/*     */ 
/*     */   
/*  53 */   private static int[][] ValTab3 = new int[][] { { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 2, 1 }, { 0, 16 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 } };
/*     */ 
/*     */   
/*  56 */   private static int[][] ValTab4 = new int[][] { { 0, 0 } };
/*     */   
/*  58 */   private static int[][] ValTab5 = new int[][] { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 2 }, { 2, 1 }, { 0, 33 }, { 0, 18 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 34 }, { 0, 48 }, { 2, 1 }, { 0, 3 }, { 0, 19 }, { 2, 1 }, { 0, 49 }, { 2, 1 }, { 0, 50 }, { 2, 1 }, { 0, 35 }, { 0, 51 } };
/*     */ 
/*     */ 
/*     */   
/*  62 */   private static int[][] ValTab6 = new int[][] { { 6, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 16 }, { 0, 17 }, { 6, 1 }, { 2, 1 }, { 0, 1 }, { 2, 1 }, { 0, 32 }, { 0, 33 }, { 6, 1 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 }, { 4, 1 }, { 2, 1 }, { 0, 49 }, { 0, 19 }, { 4, 1 }, { 2, 1 }, { 0, 48 }, { 0, 50 }, { 2, 1 }, { 0, 35 }, { 2, 1 }, { 0, 3 }, { 0, 51 } };
/*     */ 
/*     */ 
/*     */   
/*  66 */   private static int[][] ValTab7 = new int[][] { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 8, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 2 }, { 0, 33 }, { 18, 1 }, { 6, 1 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 34 }, { 0, 48 }, { 4, 1 }, { 2, 1 }, { 0, 49 }, { 0, 19 }, { 4, 1 }, { 2, 1 }, { 0, 3 }, { 0, 50 }, { 2, 1 }, { 0, 35 }, { 0, 4 }, { 10, 1 }, { 4, 1 }, { 2, 1 }, { 0, 64 }, { 0, 65 }, { 2, 1 }, { 0, 20 }, { 2, 1 }, { 0, 66 }, { 0, 36 }, { 12, 1 }, { 6, 1 }, { 4, 1 }, { 2, 1 }, { 0, 51 }, { 0, 67 }, { 0, 80 }, { 4, 1 }, { 2, 1 }, { 0, 52 }, { 0, 5 }, { 0, 81 }, { 6, 1 }, { 2, 1 }, { 0, 21 }, { 2, 1 }, { 0, 82 }, { 0, 37 }, { 4, 1 }, { 2, 1 }, { 0, 68 }, { 0, 53 }, { 4, 1 }, { 2, 1 }, { 0, 83 }, { 0, 84 }, { 2, 1 }, { 0, 69 }, { 0, 85 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 282 */   private static int[][] ValTab32 = new int[][] { { 2, 1 }, { 0, 0 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 8 }, { 0, 4 }, { 2, 1 }, { 0, 1 }, { 0, 2 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 12 }, { 0, 10 }, { 2, 1 }, { 0, 3 }, { 0, 6 }, { 6, 1 }, { 2, 1 }, { 0, 9 }, { 2, 1 }, { 0, 5 }, { 0, 7 }, { 4, 1 }, { 2, 1 }, { 0, 14 }, { 0, 13 }, { 2, 1 }, { 0, 15 }, { 0, 11 } };
/*     */ 
/*     */ 
/*     */   
/* 286 */   private static int[][] ValTab33 = new int[][] { { 16, 1 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 }, { 2, 1 }, { 0, 2 }, { 0, 3 }, { 4, 1 }, { 2, 1 }, { 0, 4 }, { 0, 5 }, { 2, 1 }, { 0, 6 }, { 0, 7 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 8 }, { 0, 9 }, { 2, 1 }, { 0, 10 }, { 0, 11 }, { 4, 1 }, { 2, 1 }, { 0, 12 }, { 0, 13 }, { 2, 1 }, { 0, 14 }, { 0, 15 } };
/*     */ 
/*     */ 
/*     */   
/* 290 */   public static huffcodetab[] ht = null;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 297 */     this.tablename0 = S.charAt(0);
/* 298 */     this.tablename1 = S.charAt(1);
/* 299 */     this.tablename2 = S.charAt(2);
/* 300 */     this.xlen = XLEN;
/* 301 */     this.ylen = YLEN;
/* 302 */     this.linbits = LINBITS;
/* 303 */     this.val = VAL;
/* 304 */     this.treelen = TREELEN;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 315 */     int dmask = Integer.MIN_VALUE;
/*     */     
/* 317 */     int point = 0;
/* 318 */     int error = 1;
/* 319 */     int level = dmask;
/*     */     
/* 321 */     if (h.val == null) return 2;
/*     */ 
/*     */     
/* 324 */     if (h.treelen == 0) {
/* 325 */       y[0] = 0; x[0] = 0;
...
/*     */     
/*     */     do {
/* 337 */       if (h.val[point][0] == 0) {
/* 338 */         x[0] = h.val[point][1] >>> 4;
/* 339 */         y[0] = h.val[point][1] & 0xF;
/* 340 */         error = 0;
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 350 */       if (br.hget1bit() != 0) {
/* 351 */         while (h.val[point][1] >= 250)
/* 352 */           point += h.val[point][1]; 
/* 353 */         point += h.val[point][1];
/*     */       } else {
/* 355 */         while (h.val[point][0] >= 250)
/* 356 */           point += h.val[point][0]; 
/* 357 */         point += h.val[point][0];
/*     */       } 
/* 359 */       level >>>= 1;
/*     */     }
/* 361 */     while (level != 0 || point < 0);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 369 */     if (h.tablename0 == '3' && (h.tablename1 == '2' || h.tablename1 == '3')) {
/* 370 */       v[0] = y[0] >> 3 & 0x1;
/* 371 */       w[0] = y[0] >> 2 & 0x1;
/* 372 */       x[0] = y[0] >> 1 & 0x1;
/* 373 */       y[0] = y[0] & 0x1;
...
/*     */ 
/*     */       
/* 379 */       if (v[0] != 0 && br.hget1bit() != 0) v[0] = -v[0]; 
/* 380 */       if (w[0] != 0 && br.hget1bit() != 0) w[0] = -w[0]; 
/* 381 */       if (x[0] != 0 && br.hget1bit() != 0) x[0] = -x[0]; 
/* 382 */       if (y[0] != 0 && br.hget1bit() != 0) y[0] = -y[0];
/*     */       
/*     */     
/*     */     }
/*     */     else {
/*     */       
/* 388 */       if (h.linbits != 0 && h.xlen - 1 == x[0]) x[0] = x[0] + br.hgetbits(h.linbits); 
/* 389 */       if (x[0] != 0 && br.hget1bit() != 0) x[0] = -x[0]; 
/* 390 */       if (h.linbits != 0 && h.ylen - 1 == y[0]) y[0] = y[0] + br.hgetbits(h.linbits); 
/* 391 */       if (y[0] != 0 && br.hget1bit() != 0) y[0] = -y[0]; 
/*     */     } 
/* 393 */     return error;
/*     */   }
/*     */ 
...
/* 398 */     if (ht != null)
/*     */       return; 
/* 400 */     ht = new huffcodetab[34];
/* 401 */     ht[0] = new huffcodetab("0  ", 0, 0, 0, 0, -1, null, null, ValTab0, 0);
/* 402 */     ht[1] = new huffcodetab("1  ", 2, 2, 0, 0, -1, null, null, ValTab1, 7);
/* 403 */     ht[2] = new huffcodetab("2  ", 3, 3, 0, 0, -1, null, null, ValTab2, 17);
/* 404 */     ht[3] = new huffcodetab("3  ", 3, 3, 0, 0, -1, null, null, ValTab3, 17);
/* 405 */     ht[4] = new huffcodetab("4  ", 0, 0, 0, 0, -1, null, null, ValTab4, 0);
/* 406 */     ht[5] = new huffcodetab("5  ", 4, 4, 0, 0, -1, null, null, ValTab5, 31);
/* 407 */     ht[6] = new huffcodetab("6  ", 4, 4, 0, 0, -1, null, null, ValTab6, 31);
/* 408 */     ht[7] = new huffcodetab("7  ", 6, 6, 0, 0, -1, null, null, ValTab7, 71);
/* 409 */     ht[8] = new huffcodetab("8  ", 6, 6, 0, 0, -1, null, null, ValTab8, 71);
/* 410 */     ht[9] = new huffcodetab("9  ", 6, 6, 0, 0, -1, null, null, ValTab9, 71);
/* 411 */     ht[10] = new huffcodetab("10 ", 8, 8, 0, 0, -1, null, null, ValTab10, 127);
/* 412 */     ht[11] = new huffcodetab("11 ", 8, 8, 0, 0, -1, null, null, ValTab11, 127);
/* 413 */     ht[12] = new huffcodetab("12 ", 8, 8, 0, 0, -1, null, null, ValTab12, 127);
/* 414 */     ht[13] = new huffcodetab("13 ", 16, 16, 0, 0, -1, null, null, ValTab13, 511);
/* 415 */     ht[14] = new huffcodetab("14 ", 0, 0, 0, 0, -1, null, null, ValTab14, 0);
/* 416 */     ht[15] = new huffcodetab("15 ", 16, 16, 0, 0, -1, null, null, ValTab15, 511);
/* 417 */     ht[16] = new huffcodetab("16 ", 16, 16, 1, 1, -1, null, null, ValTab16, 511);
/* 418 */     ht[17] = new huffcodetab("17 ", 16, 16, 2, 3, 16, null, null, ValTab16, 511);
/* 419 */     ht[18] = new huffcodetab("18 ", 16, 16, 3, 7, 16, null, null, ValTab16, 511);
/* 420 */     ht[19] = new huffcodetab("19 ", 16, 16, 4, 15, 16, null, null, ValTab16, 511);
/* 421 */     ht[20] = new huffcodetab("20 ", 16, 16, 6, 63, 16, null, null, ValTab16, 511);
/* 422 */     ht[21] = new huffcodetab("21 ", 16, 16, 8, 255, 16, null, null, ValTab16, 511);
/* 423 */     ht[22] = new huffcodetab("22 ", 16, 16, 10, 1023, 16, null, null, ValTab16, 511);
/* 424 */     ht[23] = new huffcodetab("23 ", 16, 16, 13, 8191, 16, null, null, ValTab16, 511);
/* 425 */     ht[24] = new huffcodetab("24 ", 16, 16, 4, 15, -1, null, null, ValTab24, 512);
/* 426 */     ht[25] = new huffcodetab("25 ", 16, 16, 5, 31, 24, null, null, ValTab24, 512);
/* 427 */     ht[26] = new huffcodetab("26 ", 16, 16, 6, 63, 24, null, null, ValTab24, 512);
/* 428 */     ht[27] = new huffcodetab("27 ", 16, 16, 7, 127, 24, null, null, ValTab24, 512);
/* 429 */     ht[28] = new huffcodetab("28 ", 16, 16, 8, 255, 24, null, null, ValTab24, 512);
/* 430 */     ht[29] = new huffcodetab("29 ", 16, 16, 9, 511, 24, null, null, ValTab24, 512);
/* 431 */     ht[30] = new huffcodetab("30 ", 16, 16, 11, 2047, 24, null, null, ValTab24, 512);
/* 432 */     ht[31] = new huffcodetab("31 ", 16, 16, 13, 8191, 24, null, null, ValTab24, 512);
/* 433 */     ht[32] = new huffcodetab("32 ", 1, 16, 0, 0, -1, null, null, ValTab32, 31);
/* 434 */     ht[33] = new huffcodetab("33 ", 1, 16, 0, 0, -1, null, null, ValTab33, 31);
/*     */   }
/*     */ }


/* Location:              E:\代码\SlayTheSpire\desktop-1.0.jar!\javazoom\jl\decoder\huffcodetab.class
